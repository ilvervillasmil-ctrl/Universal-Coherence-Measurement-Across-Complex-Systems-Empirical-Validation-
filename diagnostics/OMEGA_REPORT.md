...
**Generated:** 2026-04-25 07:56:55 UTC
...
| --- | --- | --- |
| Estado | **CONFLICTO ⟨◯⟩** |  |
| C_struct (Estructural) | **0.5902** | ← real, limitada por α=0.9630 |
| C_global (Normalizada) | 0.6129 | ← C_struct / α, relativa al máximo |
| C_CI (Pass Rate) | 1.0000 | ← proxy del CI, no es C_Ω |
| φ_eff (Fricción) | 2.574699 | ← basada en C_struct |
...
| Metric | Value |
| --- | --- |
| C_structural (real) | **0.5902**  ← limitada por α |
| C_global_norm | 0.6129  ← C_struct / α |
...
| dynamics.py    ← NEW v3.2 | ❌ no encontrado |
| metaconsciousness.py | ✅ activo |
| torus_formula.py ← Ley del Toroide | ❌ no encontrado |
| l7_integration.py ← L7 Integración Total | ❌ no encontrado |
...
> ⚠️ Módulo torus_formula no disponible: MODULO NO ENCONTRADO
